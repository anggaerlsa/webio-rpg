...
<template>
    <AuthBase title="Buat akun" description="Isi data di bawah untuk membuat akunmu">
        <Head title="Daftar" />
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="email" type="email" required tabindex="2" autocomplete="email" v-model="form.email" placeholder="email@contoh.com" />
